...
deltaY = Math.sin(sensorAngleEquator * Math.PI / 180.0) * objectDistanceFromSensor;
deltaX = Math.cos(sensorAngleEquator * Math.PI / 180.0) * objectDistanceFromSensor;

// https://stackoverflow.com/questions/7477003/calculating-new-longitude-latitude-from-old-n-meters
var objectLat = sensorLat + coef * deltaY;
var objectLong = sensorLong + (coef * deltaX) / Math.cos(sensorLat * Math.PI / 180.0)
...
var fov = viewer.entities.add({
    ...
    ellipsoid: {
        ...
        minimumClock: Cesium.Math.toRadians(sensorAngleEquator - (sensorVisionAngle / 2.0)),
        maximumClock: Cesium.Math.toRadians(sensorAngleEquator + (sensorVisionAngle / 2.0)),
